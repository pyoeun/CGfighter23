...
public class PlayerSponer : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameObject player1 = Resources.LoadAll<GameObject>("/PlayerPrefs/Player1").First(n => n.GetComponent<ControlManager>().PlayerType == p1Type);
        GameObject player2 = Resources.LoadAll<GameObject>("/PlayerPrefs/Player2").First(n => n.GetComponent<ControlManager>().PlayerType == p2Type);
